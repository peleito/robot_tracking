...
const int inAPin1 = 13; // right motor
const int inBPin1 = 11;
const int PWMPin1 = 2;

// constants for 2nd motor
const int inAPin2 = 10; // left motor
const int inBPin2 = 8; 
const int PWMPin2 = 4;  // check to make sure it is attached to pin with ~
...
void motor_cb( const geometry_msgs::Twist& cmd_vel){
  ...
  float left = scale*(x_des - 1.5*yaw_des) / 2;
  float right = scale*(x_des + 1.5*yaw_des) / 2;
